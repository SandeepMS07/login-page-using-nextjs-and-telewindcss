...
const Sidebar = () => {
  return (
    <div className="bg-green-500 w-60 h-screen shadow-2xl">
      <div className="border-b-2 border-b-green-100 py-5 justify-start">
      ...
      <div className="p-4 min-h-[83%] space-y-14">
        <div className="space-y-4">
          ...
          <div className="">
            <Link href={"/"} passHref>
              <div className="flex left-10  p-3 text-white space-x-4 hover:bg-gray-100 hover:rounded-2xl hover:text-green-500 cursor-pointer">
